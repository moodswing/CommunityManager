...
[assembly: WebActivator.PreApplicationStartMethod(typeof(CommunityManager.App_Start.SimpleMembershipMvc3), "Start")]
[assembly: WebActivator.PostApplicationStartMethod(typeof(CommunityManager.App_Start.SimpleMembershipMvc3), "Initialize")]
...
namespace CommunityManager.App_Start
{
	public static class SimpleMembershipMvc3
	{
		...
		public static void Initialize()
		{
            ...
            WebSecurity.InitializeDatabaseConnection(connectionStringName: "CommunityContext", userTableName: "usuarios", userIdColumn: "Id", userNameColumn: "Email", autoCreateTables: true);
		...
		public static void Start()
		{
			...
			{
                MembershipProvider provider = Membership.Providers["SimpleMembershipProvider"];
				if (provider != null)
				{
					MembershipProvider currentDefault = provider;
                    SimpleMembershipProvider provider2 = CreateDefaultSimpleMembershipProvider("SimpleMembershipProvider", currentDefault);
                    Membership.Providers.Remove("SimpleMembershipProvider");
					Membership.Providers.Add(provider2);
				}
				Roles.Enabled = true;
                RoleProvider provider3 = Roles.Providers["SimpleRoleProvider"];
				if (provider3 != null)
				{
					RoleProvider provider6 = provider3;
                    SimpleRoleProvider provider4 = CreateDefaultSimpleRoleProvider("SimpleRoleProvider", provider6);
                    Roles.Providers.Remove("SimpleRoleProvider");
